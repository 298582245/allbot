...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'images', name: 'ImageManager', component: () => import('@/views/ImageManager.vue'), meta: { title: '图床管理' } },
      { path: 'backups', name: 'Backups', component: () => import('@/views/Backups.vue'), meta: { title: '备份中心' } },
